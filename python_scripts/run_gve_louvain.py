...
executable = "./comp_exe/gve-louvain"
waitLimit = 1200
formatString = "{{{threads} threads}} -> {{{time}ms, {mark}ms mark, {init}ms init, {first}ms first, {move}ms move, {aggr}ms aggr, {iters} iters, {passes} passes, {mod} modularity}} louvainStaticOmp"
